...
<head>
    <title>ACCESO A ADMINISTRACIÓN - ZONA D</title>
    <meta name="author" content="Jose Emmanuel Castro Martel">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta charset="utf-8">
    <!-- SEO -->
    <meta name="keywords" content="Acceso a administración - Zona D">
    <meta name="description" content="Acceso a administración - Zona D">
    <meta property="og:site_name" content="Zona D"/>
    <meta property="og:title" content="ACCESO A ADMINISTRACIÓN - ZONA D">
    <meta property="og:url" content="{{url()->full()}}">
    <meta property="og:description" content="Acceso a administración - Zona D">
...
<div class="container-fluid">
    <div class="row">
        <div class="col-xl-4 col-lg-6 col-md-8 col-12 offset-xl-4 offset-lg-3 offset-md-2 offset-0 bg-white rounded align-vertical">
            <form class="px-4 pt-4 pb-5 roboto" method="post" action="{{url('login')}}">
                <h3 class="text-orange text-center impact mb-4"><b>ACCESSO A ADMINISTRACIÓN</b></h3>
                ...
                <button type="submit" class="btn btn-primary btn-block bg-black text-orange btn-outline-danger"><b>ACCEDER</b></button>
                {{csrf_field()}}
            </form>
        </div>
    </div>
